  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative w-screen h-screen overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="absolute inset-0 z-10 pt-20 md:pt-32 lg:pt-40 px-4 md:px-8 lg:px-16 pointer-events-none">
          <div className="text-left text-white drop-shadow-lg w-full max-w-xl">
            <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-6">
              마케팅 자동화로
              <br />
              <span className="text-primary drop-shadow-[0_0_30px_rgba(59,130,246,0.8)]">매출 3배 성장</span>을 경험하세요
            </h1>
            ...
            <div className="pointer-events-auto">
              <button
                onClick={scrollToForm}
                className="px-8 py-4 bg-primary hover:opacity-90 text-primary-foreground rounded-lg font-bold text-lg transition-all hover:-translate-y-0.5 hover:shadow-xl"
              >
                무료 상담 신청하기
              </button>
            </div>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            id="leadForm"
            className="max-w-2xl mx-auto bg-card border border-border rounded-2xl p-8 shadow-2xl"
          >
            <h3 className="text-2xl font-bold mb-2 text-center">무료 마케팅 진단 신청</h3>
            <p className="text-muted-foreground mb-6 text-center">48시간 내 전문가가 맞춤 전략을 보내드립니다</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-secondary border border-input rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-ring resize-vertical"
                />
              </div>

              <button
                type="submit"
                className="w-full py-4 bg-primary hover:opacity-90 text-primary-foreground rounded-lg font-bold text-lg transition-all hover:-translate-y-0.5 hover:shadow-lg"
              >
                무료 진단 받기
              </button>

              {showSuccess && (
                <div className="bg-[#10b981] text-white p-4 rounded-lg text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-muted-foreground">평균 매출 증가율</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">자동화 시스템</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-muted-foreground text-center mb-12">데이터 기반 마케팅으로 확실한 성과를 만듭니다</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-card border border-border rounded-xl p-6 hover:border-primary transition-all hover:-translate-y-1"
              >
                <div className="w-14 h-14 bg-primary rounded-xl flex items-center justify-center text-primary-foreground text-xs font-bold mb-4">
                  {feature.icon}
                </div>
